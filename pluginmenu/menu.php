 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_ts')){
	function azrcrv_create_plugin_menu_ts(){
		azrcrv_create_plugin_menu_table_ts();
		azrcrv_populate_plugin_menu_table_ts();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_ts')){
	function azrcrv_populate_plugin_menu_table_ts(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_ts')){
	function azrcrv_create_plugin_menu_table_ts(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
