...
### [Version 1.2.9](https://github.com/azurecurve/azrcrv-theme-switcher/releases/tag/v1.2.9)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 1.2.8](https://github.com/azurecurve/azrcrv-theme-switcher/releases/tag/v1.2.8)
 * Update plugin header and readme for compatibility with ClassicPress Directory v2.
 * Update Update Manager to version 2.5.0.

### [Version 1.2.7](https://github.com/azurecurve/azrcrv-theme-switcher/releases/tag/v1.2.7)
 * Update readme file for compatibility with ClassicPress Directory.
 
### [Version 1.2.6](https://github.com/azurecurve/azrcrv-theme-switcher/releases/tag/v1.2.6)
 * Update readme files.
